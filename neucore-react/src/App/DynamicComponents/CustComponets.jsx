...
const AdmissionForm = React.lazy(() =>
  import("@/Pages/Transaction/AdmissionForm")
);
...
const StudentBusReceipt = React.lazy(() =>
  import("@/Pages/Transaction/StudentBusReceipt")
);
...
const Components = {
  ...
  standard: Standard,
  division: Division,
  studentbusreceipt: StudentBusReceipt,
  ...
  studentcopyonlydata: StudentCopy,
