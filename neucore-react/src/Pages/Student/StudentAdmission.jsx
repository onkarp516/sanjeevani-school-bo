...
class StudentAdmission extends React.Component {
  ...
  getMaxFeeStandard = (id) => {
    let requestData = new FormData();
    requestData.append("standardId", id);
    getMaxFeeStandard(requestData)
      .then((response) => {
        let res = response.data;
        console.log("res", res);
        if (res.responseStatus == 200) {
          ...
          this.setState({ maxFeeData: d });
          this.myRef.current.setFieldValue(
            "maxFee",
            this.state.maxFeeData.maxFee
          );
        }
      })
      .catch((error) => {
            ...
            <Formik
              ...
              onSubmit={(values, { resetForm, setStatus, setSubmitting }) => {
                ...
                if (step < 3) {
                  ...
                  requestData.append("maxFee", values.maxFee);
                    ...
                    <Tab.Content className="p-5 pt-0 ">
                      ...
                      <Tab.Pane eventKey="3">
                        <SStep3
                          ...
                          getMaxFeeStandard={this.getMaxFeeStandard}
                          handleStateData={this.handleStateData}
                        />
                      </Tab.Pane>
                    </Tab.Content>
...
export default connect(mapStateToProps, mapActionsToProps)(StudentAdmission);
