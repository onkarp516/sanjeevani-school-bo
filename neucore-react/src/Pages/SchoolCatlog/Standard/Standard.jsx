              ...
              <Formik
                ...
                validationSchema={Yup.object().shape({
                  ...
                  branchId: Yup.object()
                    ...
                    .nullable(),
                  maxFee: Yup.string().trim().required("Max Fees is required"),
                })}
                onSubmit={(values, { setSubmitting, resetForm }) => {
                  ...
                  // requestData.append("maxFee", values.maxFee.value);
                            ...
                            <Col md="3">
                              <Form.Group>
                                ...
                                <Form.Control
                                  ...
                                  onChange={handleChange}
                                  value={values.maxFee}
                                  isValid={touched.maxFee && !errors.maxFee}
                                  isInvalid={!!errors.maxFee}
                                />
                                <span className="text-danger errormsg">
                                  {errors.maxFee}
                                </span>
...
export default connect(mapStateToProps, mapActionsToProps)(Standard);
