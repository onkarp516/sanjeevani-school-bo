...
class FeesInstallmentList extends React.Component {
  constructor(props) {
    super(props);
  ...
  deleteFeesInstallmentData = (id) => {
    console.log("this.state.initval", id);
    let requestData = new FormData();
                                ...
                                onClick={(e) => {
                                  ...
                                  if (
                                    ...
                                    MyNotifications.fire({
                                      ...
                                      handleSuccessFn: () => {
                                        this.deleteFeesInstallmentData(v.id);
                                      },
                                      handleFailureFun: () => {
...
export default connect(mapStateToProps, mapActionsToProps)(FeesInstallmentList);
