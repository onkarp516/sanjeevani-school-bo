...
export default class RoleEdit extends Component {
  ...
  componentDidMount() {
    if (AuthenticationCheck()) {
      ...
      this.setState({ RoleEditData: prop_data });
    }
  }

  componentDidUpdate() {
    let { sysPermission, orgSysPermission, isEditDataSet, RoleEditData } =
      this.state;
    console.log(
      "componentDidUpdate : ",
      sysPermission,
  ...
  getRoleWithPermissionById = () => {
    ...
    this.setState({ isEditDataSet: true }, () => {
      getRoleById(requestData)
        ...
        .catch((error) => {
          console.log("error", error);
          this.setState({ isEditDataSet: false });
        });
    });
  };
  pageReload = () => {
  ...
  render() {
    let { opRoleList, RoleInitval, showloader, actionsOptions, sysPermission } =
      this.state;
