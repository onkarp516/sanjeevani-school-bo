    ...
    return (
      <>
        ...
        <div id="printDiv" className="">
          ...
          {particularList.map((v, i) => {

            {
              v.particular == "Bus Fee" ? (
                <>
                  <Row className="mx-0">
                    <Col
                      lg="12"
                        ...
                        <Row>
                          <Col>
                            ...
                            >
                              <h3 className="h3-style"> {feesPaymentData.schoolName}</h3>
                              {/* <h3 className="h3-style">ENGLISH SCHOOL</h3> */}
                              {/* <p className="p-style" style={{ fontSize: '20px' }}><b>SANJEEVANI MODERN ENGLISH SCHOOL</b></p> */}
                              <p className="p-style" style={{ fontSize: '20px' }}>EKONDI(J.)Tq Omerga Dist. Osmanabad contact:9421994306</p>
                            </div>
                          </Col>
                        </Row>
                        <Row>
                        ...
                        >
                          <tbody className="tbody-style">
                            ...
                            <tr>
                              ...
                              <td className="text-start td-style">
                                Traveling From ................
                                <br />To <b>Sanjeevani Modern English
                                  <br /> School,Ekondi(J.)</b>
                                <br />Month __________ to __________
                                <br />Year {feesPaymentData.academicYear}
                              </td>
                              <td className="text-start td-style">
